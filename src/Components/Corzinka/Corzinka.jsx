...
const Corzinka = () => {
  ...
  return (
    <div
      style={{ display: isOpenCorzinkaModal ? "block" : "none" }}
      className="corzinka"
    >
      <div className="container corzinka-container">
        <div className="corzinka-header">
          ...
          <button
            onClick={() => closeCorzinkaModal()}
            className="corzinka-close"
          >
        ...
        <button onClick={() => openUserDataForm()} className="next_btn">Next</button>
      </div>
